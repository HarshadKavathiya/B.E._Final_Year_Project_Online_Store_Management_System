...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_report_sale_custom'] = $this->language->get('text_report_sale_custom');
$this->data['text_report_sale_custom_products'] = $this->language->get('text_report_sale_custom_products');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['report_sale_custom'] = $this->url->link('report/sale_custom', 'token=' . $this->session->data['token'], 'SSL');
$this->data['report_sale_custom_products'] = $this->url->link('report/sale_custom_products', 'token=' . $this->session->data['token'], 'SSL');
